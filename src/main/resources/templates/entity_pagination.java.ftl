...
<#if swagger>
    @ApiModel(value = "分页查询${table.comment!}请求对象", description = "分页查询${table.comment!}请求对象")
</#if>
<#if superEntityClass??>
...
<#else>
    public class Pagination${entity}Request extends PaginationRequest {
</#if>
<#-- ----------  BEGIN 字段循环遍历  ---------->

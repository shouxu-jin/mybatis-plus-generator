...
public final class FastAutoGenerator {
    ...
    public static FastAutoGenerator create(@NotNull String url, String username, String password, String schemaName) {
        return new FastAutoGenerator(new DataSourceConfig.Builder(url, username, password, schemaName));
    }

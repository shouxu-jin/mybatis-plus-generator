...
public class TableField {
    ...
    public TableField clone(TableExtendProperty tableExtendProperty) throws InvocationTargetException, IllegalAccessException {
        TableField tableField = new TableField();
        tableField.columnName = columnName;
        tableField.columnType = columnType;
        tableField.entity = entity;
        tableField.fill = fill;
        tableField.comment = comment;
        tableField.convert = convert;
        tableField.customMap = customMap;
        tableField.dataSourceConfig = dataSourceConfig;
        tableField.globalConfig = globalConfig;
        tableField.keyFlag = keyFlag;
        tableField.keyIdentityFlag = keyIdentityFlag;
        tableField.keyWords = keyWords;
        tableField.metaInfo = metaInfo;
        tableField.name = name;
        tableField.propertyName = propertyName;
        tableField.type = type;
        BeanUtils.copyProperties(tableField, tableExtendProperty);
        return tableField;
    }
}
